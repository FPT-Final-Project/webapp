    ...
    <div className="wrap-dashboard">
      ...
      <div className="wrap-appointment">
        <div className="wrap-appointment__select">
          ...
          <Table columns={columns} dataSource={users} scroll={{ y: 145 }} rowKey="id" />
        </div>
